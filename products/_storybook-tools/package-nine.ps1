# Package 5 children's 9-page story ebooks DW-EBK-014..018
...
$books = @(
  @{ sku="DW-EBK-014"; slug="the-soft-word-door"; pdf="The-Soft-Word-Door.pdf"; prefix="b14"; title="The Soft-Word Door"; wisdom="Kind words open doors that greed cannot." },
  @{ sku="DW-EBK-015"; slug="flash-and-nibble"; pdf="Flash-and-Nibble.pdf"; prefix="b15"; title="Flash and Nibble"; wisdom="Slow and steady finishes strong." },
  @{ sku="DW-EBK-016"; slug="the-friendship-pot"; pdf="The-Friendship-Pot.pdf"; prefix="b16"; title="The Friendship Pot"; wisdom="When everyone adds a little, hungry becomes feast." },
  @{ sku="DW-EBK-017"; slug="ruby-cloaks-true-path"; pdf="Ruby-Cloaks-True-Path.pdf"; prefix="b17"; title="Ruby Cloak's True Path"; wisdom="The longer kind path is safer than the shiny shortcut." },
  @{ sku="DW-EBK-018"; slug="three-little-nest-builders"; pdf="Three-Little-Nest-Builders.pdf"; prefix="b18"; title="Three Little Nest Builders"; wisdom="Careful work stands when the wind arrives." }
)
...
foreach ($b in $books) {
  ...
  # Social kit JPGs later via sharp; start with PNG then convert
  $map = @(
...
"@
  ...
  # Convert social PNGs to JPG for TikTok/IG/FB
