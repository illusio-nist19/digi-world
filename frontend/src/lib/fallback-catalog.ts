  ...
  products: [
    ...
    },
    {
      ...
      faq: [
        ...
        {
          en: { q: "How many seats? Can I resell the PDF?", a: "One technician is $67. Two shop seats is $97. Personal use. No redistribution, no marketplace dump of this PDF." },
          ar: { q: "كم مقعد؟ أقدر أبيع الـPDF؟", a: "فني واحد 67$. مقعدين للورشة 97$. استخدام شخصي. بدون إعادة نشر وبدون رمي الـPDF على الأسواق." },
          fr: { q: "Combien de sièges ? Je peux revendre le PDF ?", a: "Un tech = 67 $. Deux sièges atelier = 97 $. Usage perso. Pas de redistribution, pas de dump marketplace." },
          es: { q: "¿Cuántos asientos? ¿Puedo revender el PDF?", a: "Un técnico = 67 $. Dos asientos de taller = 97 $. Uso personal. Sin reventa ni dump en marketplaces." },
        },
        {
    ...
    },
    {
      ...
      serial: "DW-SYS-011",
      collection: "creator-lab",
      name: L("Digi World Client Tracker", "متتبع عملاء ديجي وورلد", "Client Tracker Digi World", "Client Tracker Digi World"),
      headline: L(
