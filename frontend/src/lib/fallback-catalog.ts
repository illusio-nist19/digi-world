  ...
  products: [
    {
      ...
      faq: [
        ...
        {
          en: { q: "How many seats? Can I resell it?", a: "One studio is $129. Two seats (you + second shooter or partner) is $199. Personal install only. No redistribution, no Etsy dump of this zip." },
          ar: { q: "كم مقعد؟ أقدر أبيعه؟", a: "استوديو واحد 129$. مقعدين (أنت + مصور ثاني أو شريك) 199$. تركيب شخصي. بدون إعادة نشر، وبدون رمي هذا الزيب على إتسي." },
          fr: { q: "Combien de sièges ? Je peux le revendre ?", a: "Un studio = 129 $. Deux sièges = 199 $. Install perso. Pas de redistribution, pas de dump Etsy de ce zip." },
          es: { q: "¿Cuántos asientos? ¿Puedo revenderlo?", a: "Un estudio = 129 $. Dos asientos = 199 $. Instalación personal. Sin reventa ni dump en Etsy de este zip." },
        },
        {
